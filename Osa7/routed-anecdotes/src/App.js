  ...
  return (
    <div>
      ...
      <form>
        ...
        <div>
          url for more info
          <input name='info' type={author.type} value={info.value} onChange={info.onChange} />
        </div>
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Route path='/create'>
        <CreateNew notification={notification} setNotification={setNotification} addNew={addNew}/>
      </Route>
